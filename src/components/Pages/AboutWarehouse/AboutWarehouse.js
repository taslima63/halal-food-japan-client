...
const AboutWarehouse = () => {
    return (
        <div>
            <h1 style={{ fontFamily: "'Roboto', sans-serif", fontWeight: '600', color: '#606060FF' }} className='my-5'>Know more about our Warehouse </h1>
            <div>
                <div className="px-4">
                        ...
                        <Row className="align-items-center justify-content-center">
                            ...
                            <Col sm={12} md={6}>
                                <div className="py-2 rounded-3">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/_grpOkkd8p8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            </Col>
                        </Row>
                    </Container>
